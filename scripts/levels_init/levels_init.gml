function level_info_island_init(){
	...
	register_level_info_island("champagne_island_land",{"name":"香槟岛（陆）","icon":spr_levelselect_button,"spr":spr_champagne_island_land,"description":"可以利用投手卡片或咖啡壶来来快速清理房东鼠。"})
